...
int main() {
	...
	*/
	...
	float vertices[] = {
		//Positions			//Colors
		1.8f,  1.5f, 0.0f,	5.0f, 0.0f, 0.0f,  // top right
		1.8f, -1.5f, 0.0f,	0.0f, 5.0f, 0.0f,  // bottom right
		-1.8f, -1.5f, 0.0f,	0.0f, 0.0f, 5.0f,  // bottom left
		-1.8f,  1.5f, 0.0f,	5.0f, 0.0f, 0.0f   // top left 
	};
