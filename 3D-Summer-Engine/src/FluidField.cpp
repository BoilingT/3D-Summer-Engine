...
FluidField::FluidField(const unsigned int WIDTH, const unsigned int HEIGHT, const unsigned int resolution) :
...
void FluidField::updateViewport(unsigned int width, unsigned int height)
{
