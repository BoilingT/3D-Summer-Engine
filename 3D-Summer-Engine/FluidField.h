...
private:
	...
	const float	 m_dye_dissipation						 = 0.02f;		// The rate at which the dye clears from the screen
	const float	 m_velocity_dissipation					 = 0.005f;		// The rate at which the velocities reduces to zero
