...
private:
	...
	const float	 m_pressure_dissipation					 = 0.0f;		// TODO: Explain it... What I thought it was (but it is supposedly wrong!): The rate at which the pressure field is cleared
