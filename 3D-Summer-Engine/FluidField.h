...
private:
	...
	const float	 m_dye_dissipation						 = 0.01f;		// The rate at which the dye clears from the screen
	const float	 m_velocity_dissipation					 = 0.01f;		// The rate at which the velocities reduces to zero
	...
	const float	 m_viscosity							 = 0.1f;		// Drag factor of the fluid
