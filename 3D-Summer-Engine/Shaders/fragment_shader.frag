...
void main(){
	...
	FragColor = vec4(colorValues, 1.0f) / (1+ vec4(sin(-vertexPos.y*20)*20-sin(vertexPos.x*25)*20* ourColor.y, sin(-vertexPos.y*20)*20-sin(vertexPos.x*25)*20* ourColor.y , sin(-vertexPos.y*20)*20-sin(vertexPos.x*25)*20* ourColor.y, 1.0f));
